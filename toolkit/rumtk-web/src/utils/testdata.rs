...
pub mod data {
    ...
    pub const TRIMMED_HTML_TITLE_RENDER: &str = "<div class='centered title-default-container'><h1 id='default' class='title-default'>Hello World!</h1></div>";
    ...
    pub const TRIMMED_HTML_RENDER_CSS: &str = "<link rel='preload' as='style' href='/static/css/bundle.min.css' onload='this.rel=\"stylesheet\"' onerror='this.onerror=null;this.href=\"/static/css/bundle.css\";' /><noscript><link rel='stylesheet' href='/static/css/bundle.min.css'></noscript>";
}
