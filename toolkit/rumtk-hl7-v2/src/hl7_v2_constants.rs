...
pub type ElementDesc = fn(&str) -> &'static str;
pub type ElementID = fn(&str) -> u8;
pub type ElementName = fn(u8) -> &'static str;
...
pub static V2_SEGMENT_NAMES: ElementName = |k| -> &'static str {
    match k {
        1u8 => "ABS",
        2u8 => "ACC",
        3u8 => "ADD",
